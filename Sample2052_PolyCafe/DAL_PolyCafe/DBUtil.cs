...
namespace DAL_PolyCafe
{
    public class DBUtil
    {
        public static string connString = @"Data Source=DESKTOP-ENF1FRV\SQLEXPRESS;Initial Catalog=QuanlyCafe;Integrated Security=True;Trust Server Certificate=True";
